...
import { IconCalendarCheck, IconHeartbeat, IconLayoutGrid, IconMoodHeart, IconPackage, IconReceiptRupee, IconStethoscope, IconUser, IconVaccine } from '@tabler/icons-react'
